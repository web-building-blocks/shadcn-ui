...
<ComponentPreview
  ...
  className="[&_input]:max-w-xs"
  description="An input component that shows dropdown options when typing '@' or '#'."
/>
### With Number
...
<ComponentPreview
  ...
  className="[&_input]:max-w-xs"
  description="An input component that allows users to select a country code and enter a number."
/>
### With Phone Number
...
<ComponentPreview
  ...
  className="[&_input]:max-w-xs"
  description="An input component designed for entering phone numbers with selectable country codes."
/>

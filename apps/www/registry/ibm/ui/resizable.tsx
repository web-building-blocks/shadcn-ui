...
const ResizablePanelGroup = ({
  ...
  <ResizablePrimitive.PanelGroup
    className={cn(
      "flex h-full w-full bg-gray-100 font-sans data-[panel-group-direction=vertical]:flex-col",
      className
    )}
    {...props}
  />
...
const ResizablePanel = ({
  ...
  <ResizablePrimitive.Panel
    className={cn("bg-gray-100 font-sans", className)}
    {...props}
  />
)
...
const ResizableHandle = ({
  ...
  >
    {withHandle && (
      <div className="z-10 flex h-4 w-3 items-center justify-center border bg-gray-300">

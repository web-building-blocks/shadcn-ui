  ...
  <div className="relative w-full overflow-auto">
    <table
      ...
      className={cn(
        ...
        variant === "colorful"
          ? "shadow-md border border-orange-500 rounded-lg"
          : "shadow-lg",
        className
      )}
      {...props}
...
>(({ className, variant = "default", ...props }, ref) => (
  <thead
    ...
    className={cn(
      variant === "colorful"
        ? "bg-orange-100 [&_tr]:border-b border-orange-500"
...
>(({ className, variant = "default", ...props }, ref) => (
  <tfoot
    ...
    className={cn(
      variant === "colorful"
        ? "bg-orange-200 border-t border-orange-500 font-medium"
...
>(({ className, variant = "default", ...props }, ref) => (
  <tr
    ...
    className={cn(
      variant === "colorful"
        ? "hover:bg-orange-50 even:bg-orange-100 border-b border-orange-300"
        : "hover:bg-gray-200 border-b",
      className
    )}
    {...props}
  />
...
>(({ className, variant = "default", ...props }, ref) => (
  <th
    ...
    className={cn(
      ...
      variant === "colorful"
        ? "text-orange-800 border-b border-orange-500"
        : "text-black",
      className
    )}
    {...props}
...
>(({ className, variant = "default", ...props }, ref) => (
  <td
    ...
    className={cn(
      "p-4 align-middle",
      variant === "colorful"
        ? "text-orange-800 border-b border-orange-300"
        : "text-gray-600",
      className
    )}
    {...props}
...
>(({ className, variant = "default", ...props }, ref) => (
  <caption
    ...
    className={cn(
      "mt-4 text-sm",
      variant === "colorful" ? "text-orange-600" : "text-gray-600",
      className
    )}
    {...props}
  />

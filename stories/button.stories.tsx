...
import { Button } from '../apps/www/registry/default/ui/button';
import { Toaster } from "../apps/www/registry/default/ui/toaster";
...
const meta: Meta<typeof Button> = {
  ...
  argTypes: {
    ...
    loadingText: { // New loading text control
      control: { type: 'text' },
      defaultValue: 'Loading...',
      description: 'Text to display while loading.',
    },
    icon: {
      control: { type: 'select', options: ['none', 'Mail', 'Loader', 'Plus'] },
    },
    className: {
      control: { type: 'text' },
    },
    onClick: {
      action: 'clicked',
      description: 'Simulate different actions on click.',
    },
  },
};
